...
#target_layers = ['model_42', 'model_45', 'model_32', 'model_33', 'model_34','model_47','model_48']
names = ['person']  # class names
target_layers = ['model_48']  
...
parser.add_argument('--model-path', type=str, default="./runs/train/exp3/weights/best.pt", help='Path to the model')  #cft results
#parser.add_argument('--model-path', type=str, default="/data/code/yolov5-test/mamba.pt", help='Path to the model')  #mamba results
parser.add_argument('--img-path', type=str, default="./data/datasets/LLVIP/rgb/test/images/190040.jpg", help='input image path')
parser.add_argument('--img-path2', type=str, default="./data/datasets/LLVIP/ir/test/images/190040.jpg", help='input image path')
...
parser.add_argument('--output-dir', type=str, default='runs/llvip', help='output dir')
