...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default="/data/code/mamba_LLVIP.pt", help='model.pt path(s)')
    parser.add_argument('--source1', type=str, default='/data/datasets/image_rgb_event_event_image/test/images', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source2', type=str, default='/data/datasets/image_rgb_event_/original_images/test/images', help='source')  # file/folder, 0 for webcam
